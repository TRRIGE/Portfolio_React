                ...
                <motion.div ref={ref}
                    ...
                    <div className="card" style={{ paddingTop: "70px" }}>
                        ...
                        <div className="card-body mt-2">
                            ...
                            <p className="card-text mb-4"><apan style={{ color: "#64ffda" }}>Things I enjoy designing: </apan><br /> UX, UI, Web, Logos</p>
                    ...
                    <div className="card" style={{ paddingTop: "70px" }}>
                        ...
                        <div className="card-body mt-2">
                            ...
                            <p className="card-text mb-4"><span style={{ color: "#64ffda" }}>Languages I Use: </span><br /> Node, Express, JavaScript, PHP</p>
